...
const TinyReact = (function () {
    ...
    const render = function (vdom, container, oldDom = container.firstChild) {
        diff(vdom, container, oldDom); //check change
    }
    ...
    const diff = function (vdom, container, oldDom) {
        ...
        if (!oldDom) {
            mountElement(vdom, container, oldDom); //first time render
        }
        ...
        else if (oldvdom && oldvdom.type === vdom.type) { //change in same type of new dom against old dom
